...
to setup
  ...
  create-sheep num-sheep
    [ 
      ...
      ifelse group = 1 [ set color white] [ set color brown ]
      set size 1.5  ;; easier to see
      setxy random-xcor random-ycor ]
  create-shepherds num-shepherds
    [ 
      set group one-of[1 2]
      ifelse group = 1 [ set color black] [ set color yellow ]
      set size 1.5  ;; easier to see
...
to search-for-sheep ;; shepherds procedure
  ...
  ask sheep-here [
  if (not hidden? and (group = [group] of myself or can-steal-sheep)) [
